...
struct CocktailDetailsInfo: View {
                    ...
                    VStack(alignment: .leading) {
                        ...
                        HStack(alignment: .bottom){
                            ...
                            if (cocktail.creator.count > 0) {
                                Text("info_by\(cocktail.creator.capitalized)")
                                    .font(.caption)
                                    .fontWeight(.light)
                                    .opacity(0.8)
                        ...
                        Divider()
                        Text("info_ingredients_title").font(.title2).padding(.bottom, 2)
                        
                        HStack{
                            VStack{
                                Text("info_servings").font(.subheadline).opacity(0.9)
                                
                                Picker("info_servings", selection: $selectedServing) {
                            ...
                            VStack{
                                Text("info_units").font(.subheadline).opacity(0.9)
                                
                                Picker("info_units", selection: $selectedMeasurement) {
                        ...
                        if (!cocktail.comment.isEmpty) {
                            Text("info_comment_title").font(.title3).padding(.bottom, 1)
...
#Preview {
    ...
    CocktailDetailsInfo(cocktail: testCocktail)
